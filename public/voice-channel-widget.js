...
(function () {
  ...
  class VoiceChannel {
    ...
    _checkForUpdates() {
      ...
      // Consultamos los releases evitando la caché del navegador móvil
      fetch('https://api.github.com/repos/jusephkanade/28channelvoiceapp/releases/latest?t=' + Date.now(), { cache: 'no-store' })
        .then(r => r.json())
        .then(data => {
